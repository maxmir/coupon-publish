...
<%--    <div style="text-align:right; margin-top:1em; margin-bottom: 0.2em;" />--%>
    ...
    <table id="coupon" class="table table-striped table-hover table-bordered" style="background-color: #171a1d09">
        <thead align="center">
        <tr>
            <th>쿠폰이름</th>
            <th>쿠폰설명</th>
        ...
        <c:forEach var="coupon" items="${adminCoupons }" varStatus="status">
            <tr>
                ...
                <td id="useYn"><c:out value="${coupon.use_yn }" /></td>
            </tr>
        </c:forEach>
